...
export const PATIENT_EMPOWERMENT_METRICS: readonly PatientEmpowermentMetric[] =
  [
    ...
    metric({
      ...
      note:
        "Diagnostics sector removed — sector overlap inflated heuristic coverage without trial-offering evidence.",
    }),
    metric({
    ...
    metric({
      ...
      note:
        "Mental Health sector removed — general therapy apps lack breast-cancer survivorship resource evidence.",
    }),
    metric({
      id: "not-in-control",
