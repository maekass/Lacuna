...
export const verifiedCompanies = staticDerived.verifiedCompanies as VerifiedCompany[];
export const verifiedAcquisitions = staticDerived.verifiedAcquisitions as VerifiedAcquisition[];
export const verifiedAcquirers = staticDerived.verifiedAcquirers as VerifiedAcquirerView[];
...
export const getVerifiedTotalDealValue = staticDerived.getVerifiedTotalDealValue;
