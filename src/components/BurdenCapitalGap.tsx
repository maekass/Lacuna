    ...
    >
      ...
      <details className="mt-4 rounded-lg border border-lacuna-lavender/30 bg-lacuna-lavender/10 px-4 py-3">
        ...
        <p className="mt-2 text-xs leading-relaxed text-lacuna-blue/80">
          ...
          flows). The valuation model below uses US GBD 2021 burden + Rock
          Health / PitchBook FemTech VC estimates (2019–2024). Capital figures
          are expected to differ — they answer different questions. The critical
          gap:{" "}
          <span className="font-medium text-lacuna-plum">
            cardiovascular and metabolic disorders have no valuation area
          </span>
          , so gap scoring cannot yet express the headline misclassification
          thesis.
        </p>
