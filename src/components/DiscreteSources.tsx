...
export function DiscreteSourceNote({ children, className = '' }: DiscreteSourceNoteProps) {
  return (
    <p className={`text-[10px] italic leading-snug text-gray-400 ${className}`}>{children}</p>
  );
}
