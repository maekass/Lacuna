...
export default function EndometriosisCoveragePanel() {
  ...
  const { companies, methodology, generatedAt } = ENDOMETRIOSIS_COVERAGE;
  ...
  return (
    <details className="mt-4 rounded-lg border border-lacuna-lavender/30 bg-lacuna-lavender/10 px-4 py-3">
      <summary className="cursor-pointer text-xs font-semibold text-lacuna-plum">
        Endometriosis ecosystem coverage ({stats.includedCount} for-profit cos.
        w/ funding status · {stats.verifiedOverlap} in verified dataset)
      </summary>
