      ...
      <ModelProvenanceHint model={CLINICAL_TRIALS_ML_MODEL}>
        <div className="mb-4 max-w-3xl cursor-help">
          ...
          <p className="mt-1 text-xs leading-relaxed text-lacuna-blue/80">
            Trained outside the Next.js bundle on ClinicalTrials.gov text
            fields. WH relevance tags women&apos;s-health trials; completion
            proxy estimates P(COMPLETED vs stopped) — not efficacy or approval.
            Source: {source}.
          </p>
        </div>
      </ModelProvenanceHint>
