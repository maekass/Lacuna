          ...
          <div className="bg-white border border-lacuna-border rounded-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              ...
              <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-4 rounded-lg border border-purple-200">
                <h5
                  className="text-sm uppercase tracking-wider text-purple-700 mb-2"
                  style={labelFont}
                >
                  Gini Coefficient
                </h5>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-cyan-50 p-4 rounded-lg border border-blue-200">
                <h5
                  className="text-sm uppercase tracking-wider text-blue-700 mb-2"
                  style={labelFont}
                >
                    ...
                    <div key={a.id} className="flex items-center gap-3">
                      ...
                      <div className="flex-1 h-6 bg-lacuna-surface-subtle rounded-full overflow-hidden">
                        <div
                          ...
                          style={{
                            width: `${(deals / maxDeals) * 100}%`,
                            minWidth: deals > 0 ? "30px" : "0",
                          }}
                        >
                          {deals}
                        </div>
        ...
        >
          <div className="bg-white border border-lacuna-border rounded-lg p-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
              ...
              <div className="bg-lacuna-surface-muted p-3 rounded-lg text-center">
                ...
                >
                  {stats.temporal.yearRange[1] - stats.temporal.yearRange[0] +
                    1}
                </div>
                <div
                  className="text-xs text-lacuna-text-muted uppercase mt-1"
              ...
              <div className="flex items-end gap-2 h-32">
                {(() => {
                  const maxCount = Math.max(
                    ...stats.temporal.yearlyData.map((d) => d.count),
                    1,
                  );
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
                <div>
                  ...
                  <div className="font-medium capitalize">
                    {stats.temporal.trend.interpretation.replace("_", " ")}
                  </div>
                </div>
                <div>
                  <div className="text-xs text-lacuna-text-muted uppercase">
                ...
                <div>
                  ...
                  <div
                    className={`font-medium capitalize ${
                      stats.temporal.trend.confidence === "high"
                        ? "text-green-600"
                        : stats.temporal.trend.confidence === "medium"
                        ? "text-yellow-600"
                        : "text-red-600"
                    }`}
                  >
          ...
          <div className="bg-gradient-to-r from-[#E8B4B8] via-[#B8A9C9] to-[#4A5D8A] p-6 rounded-lg text-white">
            ...
            <p className="text-sm leading-relaxed">
              With {stats.temporal.totalAcquisitions} events over{" "}
              {stats.temporal.yearRange[1] - stats.temporal.yearRange[0] + 1}
              {" "}
              years, year-to-year variation is high. Trend shows{" "}
              {stats.temporal.trend.interpretation.replace("_", " ")}{" "}
              pattern with R² = {stats.temporal.trend.rSquared.toFixed(2)}{" "}
              ({stats.temporal.trend.confidence.replace("_", " ")} confidence).
              <strong>Do not extrapolate this trend forward</strong>{" "}
              - too noisy for forecasting.
            </p>
          </div>
        </motion.div>
      )}
      ...
      {activeTab === "communities" && (
        ...
        >
          <div className="bg-white border border-lacuna-border rounded-lg p-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
                ...
                <div
                  className={`text-2xl font-light ${
                    stats.communities.stability.score > 0.85
                      ? "text-green-600"
                      : stats.communities.stability.score > 0.7
                      ? "text-yellow-600"
                      : "text-red-600"
                  }`}
                  style={displayFont}
              ...
              <div className="bg-lacuna-surface-muted p-3 rounded-lg text-center">
                <div
                  ...
                  style={{
                    fontFamily: DISPLAY_FONT,
                    color: stats.communities.stability.isReliable
                      ? "#22c55e"
                      : "#e76f51",
                  }}
                >
              ...
              <div className="space-y-2">
                {stats.communities.communitySizes.map((size, i) => {
                  const maxSize = Math.max(
                    ...stats.communities.communitySizes,
                    1,
                  );
                  return (
            ...
            >
              <strong>Stability Assessment:</strong>{" "}
              {stats.communities.stability.interpretation}. Score of{" "}
              {stats.communities.stability.score.toFixed(2)}{" "}
              measured via 10 random subset perturbations.
            </div>
          ...
          <div className="bg-gradient-to-r from-[#E8B4B8] via-[#B8A9C9] to-[#4A5D8A] p-6 rounded-lg text-white">
            ...
            <p className="text-sm leading-relaxed">
              Greedy modularity optimization identified{" "}
              {stats.communities.numCommunities} clusters with modularity Q =
              {" "}
              {stats.communities.modularity.toFixed(3)}. Stability assessment
              gives
              {(stats.communities.stability.score * 100).toFixed(0)}%
              consistency under perturbation, indicating{" "}
              <strong>
                {stats.communities.stability.isReliable
                  ? "meaningful structure"
                  : "likely small-n artifact"}
              </strong>.
              {stats.communities.qualitativeDescription.length > 0
                ...
                : ""}
              <strong>
                Adding 5 more nodes would likely change community structure
                significantly.
              </strong>
            </p>
          </div>
      ...
      {activeTab === "stability" && (
        ...
        >
          <div className="bg-white border border-lacuna-border rounded-lg p-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-4">
              ...
              <div className="bg-lacuna-surface-muted p-3 rounded-lg text-center">
                ...
                >
                  {stats.stability.findingReliability.filter((f) =>
                    f.reliability === "high"
                  ).length}
                </div>
                <div
            ...
            <div className="bg-amber-50 border border-amber-200 rounded p-3">
              <h5 className="font-medium text-amber-800 mb-1 text-sm">
                Caveats
              </h5>
          ...
          <div className="bg-gradient-to-r from-[#E8B4B8] via-[#B8A9C9] to-[#4A5D8A] p-6 rounded-lg text-white">
            ...
            <p className="text-sm leading-relaxed">
              Of 5 network metrics tested,{" "}
              {Object.values(stats.stability.metricStability).filter((m) =>
                m.isStable
              ).length}{" "}
              are stable (CV &lt; 15%). Recommend collecting data to n={stats
                .stability.recommendedSampleSize} for reliable findings.
              <strong>
                Treat low-reliability findings as exploratory only.
              </strong>{" "}
              When sample reaches 25 acquisitions, refit all models and compare
              - substantial changes (&gt;20%) indicate original findings were
              unstable.
            </p>
          </div>
        </motion.div>
        ...
        >
          <div className="bg-white border border-lacuna-border rounded-lg p-6">
            ...
            <p className="text-sm text-lacuna-text-secondary mb-4">
              ...
              tells us whether observed concentration is meaningful.
            </p>
      ...
      {activeTab === "limitations" && (
        ...
        >
            ...
            <ul className="space-y-3 text-sm text-red-700">
              <li>
                ...
                <div className="text-xs mt-1 ml-4">
                  Power law fitting to n={sampleNodes.length}{" "}
                  is unreliable. Requires n&gt;{POWER_LAW_LIMITATIONS
                    .minimumSampleSize}
                  (Clauset et al., 2009).
                </div>
              </li>
              <li>
                ...
                <div className="text-xs mt-1 ml-4">
                  Requires temporal data showing growth dynamics + n&gt;100. We
                  have a snapshot.
                </div>
              </li>
              <li>
                ...
                <div className="text-xs mt-1 ml-4">
                  This is one snapshot of FemTech acquisitions, not a
              ...
              <li>
                ...
                <div className="text-xs mt-1 ml-4">
                  Betweenness/eigenvector centrality has high variance with
                  n=15. Adding one acquisition could reshuffle rankings.
                </div>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-gradient-to-r from-[#E8B4B8] via-[#B8A9C9] to-[#4A5D8A] p-6 rounded-lg text-white">
            ...
            <p className="text-sm leading-relaxed">
              With {sampleNodes.length} nodes and {sampleEdges.length}{" "}
              edges, we focus on what&apos;s defensible: bootstrap confidence
              intervals, robust concentration metrics (Gini, HHI), and null
              model comparison. We <strong>do not</strong>{" "}
              fit power laws, claim preferential attachment, or rank specific
              centralities. The acquisition network shows{" "}
              {stats.gini.interpretation.toLowerCase()}{" "}
              with top-3 acquirers controlling{" "}
              {(stats.gini.topConcentration.top3 * 100).toFixed(0)}% of deals -
              {Math.abs(stats.nullModel.zScore.gini) > 2
