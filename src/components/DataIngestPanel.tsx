        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-2">
          <section className="rounded-lg border border-lacuna-lavender/30 p-4">
            ...
            <p className="mt-1 text-xs text-lacuna-blue">
              Daily 8-K Item 2.01 scan → <code className="text-[11px]">lacuna_deals</code>{" "}
              staging. See{" "}
              <a
            ...
            {sec?.ok && sec.latest ? (
              <dl className="mt-3 grid grid-cols-2 gap-2 text-xs">
                <div>
                  ...
                  <dd className="font-medium text-lacuna-plum">{sec.latest.status}</dd>
                </div>
                <div>
          ...
          <section className="rounded-lg border border-lacuna-lavender/30 p-4">
            ...
            <p className="mt-1 text-xs text-lacuna-blue">
              Batch JSON for ClinicalTrials.gov, openFDA, SEC facts, NIH, PubMed,
              Wikidata, and more. See{" "}
              <a
            ...
            {freeApi?.latest ? (
              <dl className="mt-3 grid grid-cols-2 gap-2 text-xs">
                ...
                <div>
                  ...
                  <dd className="font-medium text-lacuna-plum">
                    {freeApi.latest.entityFileCount}/{freeApi.latest.entityCount}
                  </dd>
                </div>
                <div className="col-span-2">
