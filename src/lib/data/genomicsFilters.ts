...
const GENOMICS_KEYWORD = /genomic|genome|sequenc|brca|biomarker|hereditary|carrier screening|cgp|profiling|variant|exome|oncotype/i;

/** Diagnostics sector and genomics-related portfolio companies. */
export function isGenomicsRelevantCompany(company: VerifiedDataset['companies'][number]): boolean {
