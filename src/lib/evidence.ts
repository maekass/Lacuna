...
// ----------------------------------------------------------------------------
type SignalTable = Readonly<
  Record<EvidenceClass, ReadonlyArray<readonly [string, number]>>
>;
...
const SIGNALS: SignalTable = {
  ...
  diagnostic_genomic: [
    ...
    ["nipt", 5],
    ["non-invasive prenatal", 6],
    ["carrier screen", 5],
    ["preimplantation genetic", 6],
    ["prognostic", 4],
    ["point-of-care", 5],
    ["elastography", 5],
    ["radiography", 5],
  ...
  fertility_science: [
    ["ivf", 5],
    ["assisted reproduct", 6],
    ["assisted reproductive", 6],
    ["embryo", 5],
    ["culture media", 6],
    ["micro-tools", 5],
    ["labware", 5],
