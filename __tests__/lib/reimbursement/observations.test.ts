...
describe("ingestion contract", () => {
  ...
  it("rejects AMA/CPT full-text storage without a license determination", () => {
    const result = validateReimbursementSourceManifest({
      ...
      artifacts: [{
        id: "artifact:ama:cpt",
        title: "CPT codebook excerpt",
        publisher: "American Medical Association",
        artifactType: "ama_reference",
        sourceUrl: "https://www.ama-assn.org/practice-management/cpt",
        retrievedAt: now,
        format: "pdf",
        storagePolicy: "full_text_allowed",
