...
# ============================================================================
# HERO SECTION - DATA-DRIVEN CLAIMS (clinical green palette)
# ============================================================================
st.markdown(
    ...
    '<div style="color: #5A8A6F; font-size: 2rem; font-weight: 700; margin-bottom: 0.375rem;">6,523</div>'
    ...
    '<div style="background: #FFFFFF; padding: 1.25rem; border-radius: 10px; '
    'border: 1px solid #D8E3D6; text-align: center;">'
    '<div style="color: #5A8A6F; font-size: 2rem; font-weight: 700; margin-bottom: 0.375rem;">82%</div>'
    '<div style="color: #2A3B2E; font-size: 0.8125rem; font-weight: 600; text-transform: uppercase; '
    'letter-spacing: 0.04em;">Trial Success Rate</div>'
    '<div style="color: #6B7C6F; font-size: 0.75rem; margin-top: 0.375rem;">2010-2023 outcomes</div>'
    '</div>'
    '<div style="background: #FFFFFF; padding: 1.25rem; border-radius: 10px; '
    'border: 1px solid #D8E3D6; text-align: center;">'
    '<div style="color: #5A8A6F; font-size: 2rem; font-weight: 700; margin-bottom: 0.375rem;">5</div>'
    '<div style="color: #2A3B2E; font-size: 0.8125rem; font-weight: 600; text-transform: uppercase; '
    ...
    '<div style="background: #FFFFFF; padding: 1.25rem; border-radius: 10px; '
    'border: 1px solid #D8E3D6; text-align: center;">'
    '<div style="color: #5A8A6F; font-size: 2rem; font-weight: 700; margin-bottom: 0.375rem;">100%</div>'
    '<div style="color: #2A3B2E; font-size: 0.8125rem; font-weight: 600; text-transform: uppercase; '
    ...
    '<strong style="color: #5A8A6F;">&#10003; Scientific Integrity:</strong> All data verifiable and reproducible'
    '</p></div></div>',
    unsafe_allow_html=True,
)
