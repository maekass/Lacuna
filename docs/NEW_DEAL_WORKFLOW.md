...
[DATA_BOUNDARIES.md](./DATA_BOUNDARIES.md). Keyword or LLM classification
alone never satisfies promotion gates. `strategicRationale` is curated copy
from primary source language — not an LLM summary of the 8-K.
