...
The Reimbursement Intelligence Layer integrates CMS HCPCS/CPT code data with Lacuna's company database to assess whether acquired companies have insurance reimbursement coverage—**a key driver of 5-10x valuation premiums** in healthcare M&A.

## Why This Matters

**Reimbursement = Recurring Revenue + Predictability**

Companies with established CPT codes command significantly higher valuation multiples:
...
1. **CMS Physician Fee Schedule**
   - URL: https://www.cms.gov/medicare/medicare-fee-for-service-payment/physician-fee-schedule/overview
   - Updates: Quarterly
   - Format: CSV/Excel
...
- ✅ Enable: "Acquiring company can expand insurance footprint with this acquisition"
...
1. CMS Medicare Fee Schedule: https://www.cms.gov/medicare/medicare-fee-for-service-payment/physician-fee-schedule/overview
2. HCPCS Codes: https://www.cms.gov/medicare/coding/medhcpcsgeninfo
3. Women's Health CPT Code Reference: https://www.acog.org/practice-management/coding/cpt-codes
