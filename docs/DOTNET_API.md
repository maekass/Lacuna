...
Optional **ASP.NET Core sidecar** for Lacuna — complements the Next.js REST routes
with C#, OpenAPI (Swagger), and **Entity Framework Core** for Postgres research
studies. Runs locally or in Docker; it is **not** part of the Vercel production
deployment.
