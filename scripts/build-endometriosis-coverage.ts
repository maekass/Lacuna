...
const CLINICAL_SERVICE_PATTERNS = [
  ...
  /\bgynecolog/i,
  /\bgynaecolog/i,
  /\bfertility (partnership|center|centre|clinic|partners|florida|partnership)\b/i,
  ...
  /\bmaternidade\b/i,
  /\bspecialists of\b/i,
  /\bprovides (health care|womens health|obstetric|gynecology|treatment services)\b/i,
  /\boffers (obstetric|gynecology|infertility|fertility|health care services)\b/i,
  /\b(acupuncture|physical therapy|wellness centre|functional medicine)\b/i,
  /\b(dr\.|m\.d\.)\b/i,
  /\breproductive (associates|institute|partnership|surgery center)\b/i,
